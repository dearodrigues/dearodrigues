        ...
        <div class="card mt-3 col-lg-6" style="margin: auto;"> 
            <div class="card-body p-0">            
                <div class="container-fluid p-0">
                    <div class="row ">                    
                            <img class="img-fluid position-relative" style="width: 100%" src="/assets/images/bg-perg-13.png">       
                    </div>
                </div>
                <div class="container-fluid">
                        ...
                        <div class="col-md-6 ">
                            ...
                            <form action="questao14.php" method="post">
                                <div class="mb-3 mt-2 rounded" style="border:solid 1px; border-color: #3C5BC8">
                                    <input class="form-control form-control-lg "  type="submit" value="Nem um pouco" name="btnq13">
                                </div>
                                <div class="mb-3 mt-2 rounded" style="border:solid 1px; border-color: #3C5BC8">
                                    <input class="form-control form-control-lg" type="submit" value="Só um pouco" name="btnq13">
                                </div>
                                <div class="mb-3 mt-2 rounded" style="border:solid 1px; border-color: #3C5BC8">
                                    <input class="form-control form-control-lg" type="submit" value="Bastante" name="btnq13">
                                </div>
                                <div class="mb-3 my-2 rounded" style="border:solid 1px; border-color: #3C5BC8">
                                    <input class="form-control form-control-lg" type="submit" value="Demais" name="btnq13">
                                </div>                       
                            </form>
                        </div>   
                    </div>        
