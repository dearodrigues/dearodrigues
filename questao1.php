...
<body style="overflow: hidden">
    ...
    <div class="card mt-3" style="width: 75%; height:100%; margin: auto;">        
        <div class="card-body p-0">            
            <div class="container-fluid p-0">
                <div class="row ">
                    <div class="col-md-12 d-flex justify-content-center">
                        <img class="img-fluid position-relative" style="width: 70%" src="/assets/images/bg-perg-1.png">               
                    </div>                    
                </div>
            </div>
            <div class="container-fluid">
                <div class="row d-flex justify-content-center">                    
                    <div class="col-md-8 mb-2">
                        <div class="h5" style="text-align: center; font-family: 'Prompt', sans-serif; font-weight: bold;">
                            <p>Não consegue prestar muita atenção a detalhes ou comete erros por descuido nos trabalhos da escola ou tarefas.</p>
                        </div>
